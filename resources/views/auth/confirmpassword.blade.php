...
<div class="login-box bg-white box-shadow border-radius-10">
    ...
    <form action="{{ route('lupapassword.store') }}" method="post">
        ...
        <input type="hidden" name="id" value="{{ $cekuser->first()->id }}">
        <div class="form-group">
            <label for="">Nama</label>
            <input type="text" name="nama" class="form-control" value="{{ $cekuser->first()->name }}" readonly>
        </div>
        <div class="form-group">
            <label for="">Email</label>
            <input type="text" name="email" class="form-control" value="{{ $cekuser->first()->email }}" readonly>
        </div>
        <div class="form-group">
