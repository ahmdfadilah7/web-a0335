...
<div class="card-box pd-20">
    <h2 class="h4 mb-20">Pengajuan Judul</h2>
    <div class="row align-items-center">
        <div class="col-md-12">
            ...
            @if (Auth::user()->role->title=='Mahasiswa')
                <a href="#" data-toggle="modal" data-target="#inputData" type="button" class="btn btn-primary mb-4"><i class="fa fa-plus"></i> Pengajuan Judul</a>
            @endif
            <div class="table table-responsive">
                <table class="data-table table stripe hover nowrap">
                    ...
                    <tbody>
                        @foreach ($pengajuanjudul as $no => $value)
                            <tr>
                                <td>{{ ++$no }}</td>
                                <td>{{ $value->name }}</td>
                                <td>{{ $value->judul }}</td>
                                ...
                                <td>
                                    <button
                                        ...
                                        data-toggle="modal"
                                        data-url="{{ route('pengajuanjudul.show', $value->id) }}"
                                    ...
                                    @elseif (Auth::user()->role->title=='Dosen')
                                        @if ($value->status==0)
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm tolakData mb-2" value="{{ $value->id }}" title="Tolak"><i class="icon-copy bi bi-x-octagon"></i></button>
                                        @endif
                                    @endif
                                </td>
                            </tr>
...
@include('pengajuanjudul.partials.deleteModal')
@include('pengajuanjudul.partials.tolakModal')
@include('pengajuanjudul.partials.viewModal')
@include('pengajuanjudul.partials.modal')
