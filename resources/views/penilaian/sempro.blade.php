...
<div class="card-box pd-20">
    <h2 class="h4 mb-20">Nilai Seminar Proposal</h2>
                                ...
                                <td>
                                    @if(Auth::user()->role->title=='Dosen')                                        
                                        <button
                                            ...
                                            data-toggle="modal"
                                            data-url="{{ route('penilaian.editsempro', $row->id) }}"
...
@include('penilaian.partials.addsempro')
@include('penilaian.partials.editsempro')
@include('penilaian.partials.deletesempro')
    ...
    <script>
        $('.editData').click(function (e) {
            ...
            $.get(url, function(data){
                $('#edit_sempro').modal('show');
                $('#semproID').val(data.id);                
