...
<div class="card-box pd-20">
    <h2 class="h4 mb-20">Nilai Sidang TA 2</h2>
                                ...
                                <td>
                                    @if(Auth::user()->role->title=='Dosen')                                        
                                        <button
                                            ...
                                            data-toggle="modal"
                                            data-url="{{ route('penilaian.editsidang', $row->id) }}"
                                            data-target="#edit_sidang"
                                            title="Edit"
                                        >
...
@include('penilaian.partials.addsidang')
@include('penilaian.partials.editsidang')
@include('penilaian.partials.deletesidang')
    ...
    <script>
        $('.editData').click(function (e) {
            ...
            $.get(url, function(data){
                $('#edit_sidang').modal('show');
                $('#sidangID').val(data.id);                
