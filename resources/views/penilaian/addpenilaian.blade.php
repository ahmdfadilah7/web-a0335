    ...
    <div class="card-box pd-20">
        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                @endif
                @if(Request::segment(2)=='nilai_ta2')
                    {!! Form::open(['method' => 'post', 'route' => ['penilaian.store_ta2'], 'enctype' => 'multipart/form-data']) !!}
                @else
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select name="pengajuanjudul_id" id="judulId" class="form-control">
                                <option value="0">- Pilih -</option>
