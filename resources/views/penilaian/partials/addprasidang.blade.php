        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="pd-20 card-box mb-30">
                    @if(Request::segment(2)=='prasidangpenguji')
                        {!! Form::open(['method' => 'post', 'route' => ['penilaian.addprasidangpenguji'], 'enctype' => 'multipart/form-data']) !!}
                    @elseif (Request::segment(2)=='prasidangpembimbing')
                        {!! Form::open(['method' => 'post', 'route' => ['penilaian.addprasidangpembimbing'], 'enctype' => 'multipart/form-data']) !!}
                    @endif
                    @csrf
                    <div class="row">
