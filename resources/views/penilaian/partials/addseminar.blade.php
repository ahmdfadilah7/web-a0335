        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="pd-20 card-box mb-30">
                    @if(Request::segment(2)=='seminarpenguji')
                        {!! Form::open(['method' => 'post', 'route' => ['penilaian.addseminarpenguji'], 'enctype' => 'multipart/form-data']) !!}
                    @elseif (Request::segment(2)=='seminarpembimbing')
                        {!! Form::open(['method' => 'post', 'route' => ['penilaian.addseminarpembimbing'], 'enctype' => 'multipart/form-data']) !!}
                    @endif
                    @csrf
                    <div class="row">
