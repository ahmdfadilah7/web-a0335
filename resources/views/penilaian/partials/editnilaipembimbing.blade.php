<div class="modal fade bs-example-modal-lg" id="edit_pembimbing" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="pd-20 card-box mb-30">
                    {!! Form::open(['method' => 'post', 'route' => ['penilaian.updatepembimbing'], 'enctype' => 'multipart/form-data']) !!}
                    @if(Request::segment(2)=='nilaipembimbingta_1')
                        @php
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="pembimbing_id" id="pembimbingID">
                        ...
                        @if(Request::segment(2)=='nilaipembimbingta_2')
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="nilai_6" id="nilai_6" class="form-control">
                                    <p class="font-12 text-secondary">
                                        <i>({{ $ket_n6 }})</i>
                                    </p>
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="nilai_7" id="nilai_7" class="form-control">
                                    <p class="font-12 text-secondary">
                                        <i>({{ $ket_n7 }})</i>
                                    </p>
                                </div>
