<div class="modal fade bs-example-modal-lg" id="edit_seminar" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="pd-20 card-box mb-30">
                    {!! Form::open(['method' => 'post', 'route' => ['penilaian.updateseminar'], 'enctype' => 'multipart/form-data']) !!}
                    @csrf
                    <div class="row">
